  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, the ultimate restaurant management app where customers reserve tables and employees manage reservations and menus effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, the ultimate restaurant management app where customers reserve tables and employees manage reservations and menus effortlessly.`}
            </Text>
            <Box
